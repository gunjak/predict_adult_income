...
from income_prediction.logger import logging, get_log_file_name
...
class Pipeline(Thread):
    ...
    def run_pipeline(self):
        try:
            ...
            if model_evaluation_aritfact.is_model_accepted:
                model_pusher_artifact=self.start_model_pusher(model_eval_artifact=model_evaluation_aritfact)
            ...
            Pipeline.experiment=Experiment(experiment_id=Pipeline.experiment.experiment_id,
                                           ...
                                           experiment_file_path=Pipeline.experiment_file_path,
                                           is_model_accepted=model_evaluation_aritfact.is_model_accepted,
